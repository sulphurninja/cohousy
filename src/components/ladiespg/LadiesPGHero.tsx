...
const stats = [
  ...
  { value: '5 Min', label: 'to Eon IT Park', icon: Home },
  { value: '4.9★', label: 'Safety Rating', icon: Star }
]
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          src="/skyline.avif"
          alt="Safe ladies PG in Kharadi Pune near Eon IT Park"
          fill
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.span
              ...
              className="inline-flex items-center gap-3 px-6 py-2 text-sm font-medium tracking-wider text-gray-700 bg-pink-50 border border-pink-100 rounded-full shadow-sm mb-6"
            >
            ...
            <div className="mb-6">
              <motion.h1 className="text-display-xl font-bold text-black leading-[0.9]">
                ...
                <div className="overflow-hidden">
                  <motion.span variants={withMotion(splitLineReveal)} className="block">
                    <span className="text-pink-600">Kharadi Pune</span>
                  </motion.span>
                </div>
              </motion.h1>
            </div>
            ...
            >
              Safe & Secure Accommodation for Women
            </motion.p>
          ...
          >
            ...
            <div className="absolute top-8 right-8 bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 font-medium">Female Only</div>
              </div>
            </div>

            <div className="absolute bottom-8 left-8 bg-pink-600/95 backdrop-blur-sm text-white p-6 rounded-xl shadow-lg">
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">24/7</div>
                <div className="text-sm text-white/80 font-medium">Security</div>
              </div>
            </div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="text-center p-6 bg-pink-50 rounded-xl border border-pink-100">
                <IconComponent size={32} className="text-pink-600 mx-auto mb-3" />
